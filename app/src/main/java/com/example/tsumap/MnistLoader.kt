...
/**
 * Dataset for network training after resizing MNIST from 28x28 to 50x50.
 * Each image is flattened to FloatArray(size = 2500) with values in [0f, 1f].
 */
...
object MnistLoader {
    ...
    /**
     * Nearest-neighbor resize 28x28 -> 50x50 without external libraries.
     */
